...
![RIVERR](./app-screenshot.png)

RIVERR is a freelance marketplace website, inspired by fiverr.com, where users can create buyer and seller profiles, offer gigs, communicate with each other, and make payments using the Stripe API.
...
Check out the live site: [RIVERR Live](https://www.example.com)
...
4. Run the backend server at port 5000:
